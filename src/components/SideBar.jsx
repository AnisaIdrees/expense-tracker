    ...
    <>
      ...
      <div
        className={` sidebar 
            ...
            `}
      >
        <h1 className="text-xl text-[26px] uppercase text-white font-bold mb-4 pl-4 tracking-wide ">
          <HiChartBar className="text-[aqua]" /> Expe
          <span className="text-[aqua]">nsio</span>
        </h1>
        ...
        <ul className="space-y-3">
          <li>
            ...
            >
              ...
              <span className="ms-3 group-hover:text-aqua-600 dark:group-hover:text-aqua-400 isActive{}">
                Dashboard
              </span>
            </NavLink>
          </li>
          ...
          <li>
            ...
            >
              ...
              <span className="ms-3 group-hover:text-aqua-600 dark:group-hover:text-aqua-400">
                Add Income
              </span>
            </NavLink>
          </li>
        ...
        <div className="profile mt-16 flex gap-2 ">
          <div className="prof ">
            <img
              src="profile.png"
              alt="profile"
          ...
          <div className="info pt-2 text-[14px]">
            <h1>{currentUser?.email?.split('@')[0]||'guest user' }</h1>
            <p>{currentUser?.email}</p>
          </div>
        </div>
          <ToastContainer  className='ml-60' position="top-left" theme="dark" />
