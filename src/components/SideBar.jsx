    ...
    return (
        <>
            ...
            <div className={` sidebar 
                ...
                shadow-xl
            `}>
                <h1 className='text-xl text-[26px] uppercase text-white font-bold mb-5 pl-7 tracking-wide '>Expe<span className='text-[aqua]'>nsio</span></h1>
                ...
                <ul className="space-y-3">
                    ...
                    <li>
                        ...
                        >
                            ...
                            <span className="ms-3 group-hover:text-aqua-600 dark:group-hover:text-aqua-400">Sign Up</span>
                        </NavLink>
                    </li>
